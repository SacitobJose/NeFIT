...
-type 'SubscribeProducer'() :: #'SubscribeProducer'{}.

-type 'UnsubscribeProducer'() :: #'UnsubscribeProducer'{}.

-type 'SaleInfo'() :: #'SaleInfo'{}.

-type 'DealerTimeout'() :: #'DealerTimeout'{}.

-export_type(['Authentication'/0, 'ServerResponse'/0, 'Produce'/0, 'Import'/0, 'SubscribeProducer'/0, 'UnsubscribeProducer'/0, 'SaleInfo'/0, 'DealerTimeout'/0]).

-spec encode_msg(#'Authentication'{} | #'ServerResponse'{} | #'Produce'{} | #'Import'{} | #'SubscribeProducer'{} | #'UnsubscribeProducer'{} | #'SaleInfo'{} | #'DealerTimeout'{}) -> binary().
encode_msg(Msg) when tuple_size(Msg) >= 1 ->
    encode_msg(Msg, element(1, Msg), []).

-spec encode_msg(#'Authentication'{} | #'ServerResponse'{} | #'Produce'{} | #'Import'{} | #'SubscribeProducer'{} | #'UnsubscribeProducer'{} | #'SaleInfo'{} | #'DealerTimeout'{}, atom() | list()) -> binary().
...
encode_msg_SubscribeProducer(#'SubscribeProducer'{username
						      = F1,
						  producerName = F2},
			     Bin, TrUserData) ->
    B1 = begin
...
encode_msg_UnsubscribeProducer(#'UnsubscribeProducer'{username
							  = F1,
						      producerName = F2},
			       Bin, TrUserData) ->
    B1 = begin
...
dfp_read_field_def_Produce(<<>>, 0, 0, F@_1, F@_2, F@_3,
			   F@_4, F@_5, _) ->
    #'Produce'{productName = F@_1, minimumAmount = F@_2,
...
dfp_read_field_def_SubscribeProducer(<<>>, 0, 0, F@_1,
				     F@_2, _) ->
    #'SubscribeProducer'{username = F@_1,
			 producerName = F@_2};
...
dfp_read_field_def_UnsubscribeProducer(<<>>, 0, 0, F@_1,
				       F@_2, _) ->
    #'UnsubscribeProducer'{username = F@_1,
			   producerName = F@_2};
...
merge_msg_SubscribeProducer(#'SubscribeProducer'{},
			    #'SubscribeProducer'{username = NFusername,
...
merge_msg_UnsubscribeProducer(#'UnsubscribeProducer'{},
			      #'UnsubscribeProducer'{username = NFusername,
						     producerName =
							 NFproducerName},
			      _) ->
    #'UnsubscribeProducer'{username = NFusername,
...
v_msg_SubscribeProducer(#'SubscribeProducer'{username =
						 F1,
					     producerName = F2},
			Path, TrUserData) ->
...
v_msg_UnsubscribeProducer(#'UnsubscribeProducer'{username
						     = F1,
						 producerName = F2},
			  Path, TrUserData) ->
    v_type_string(F1, [username | Path], TrUserData),
    ...
    [{{enum, 'Authentication.AuthType'},
     ...
     {{msg, 'Produce'},
      [#field{name = productName, fnum = 1, rnum = 2,
	      type = string, occurrence = required, opts = []},
       #field{name = minimumAmount, fnum = 2, rnum = 3,
	      type = int64, occurrence = required, opts = []},
       #field{name = maximumAmount, fnum = 3, rnum = 4,
	      type = int64, occurrence = required, opts = []},
       #field{name = minimumUnitaryPrice, fnum = 4, rnum = 5,
	      type = int64, occurrence = required, opts = []},
       #field{name = negotiationPeriod, fnum = 5, rnum = 6,
	      type = int64, occurrence = required, opts = []}]},
     {{msg, 'Import'},
      [#field{name = productName, fnum = 1, rnum = 2,
	      type = string, occurrence = required, opts = []},
       ...
       #field{name = quantity, fnum = 3, rnum = 4,
	      type = int64, occurrence = required, opts = []},
       #field{name = unitaryPrice, fnum = 4, rnum = 5,
	      type = int64, occurrence = required, opts = []}]},
...
get_msg_containment("protos") ->
    ['Authentication', 'DealerTimeout', 'Import', 'Produce',
     'SaleInfo', 'ServerResponse', 'SubscribeProducer',
     'UnsubscribeProducer'];
